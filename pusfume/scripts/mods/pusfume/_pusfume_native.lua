...
-- Dead end (v0.6.83): loading resource_packages/common_shaders for the claw
-- material parent. Application.can_get("package", ...) is false for it, so
-- the gate poisoned all_loaded and disabled the whole first-person system.
-- The bundle's shared material payloads (4F76323884D2753D, D97596A091982F4B)
-- are engine-resident in Adventure anyway: the working human-hand child
-- parents D97596A091982F4B, whose only payload ships in that same bundle.
local state = {
